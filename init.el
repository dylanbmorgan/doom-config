...
(doom! :input
       ...
       (corfu
        +icons
        ;; +orderless
        +dabrev)  ; complete with cap(f), cape and a flying feather!
       ...
       ;; TODO when evil commands are supported
       (smooth-scroll)
       ...
       (objed
        +manual)             ; text object editing for the innocent
       ...
       (fortran
        ;; +intel
        +lsp)           ; in FORTRAN, GOD is REAL (unless declared INTEGER)
