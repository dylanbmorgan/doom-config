...
Also use languagetool with flycheck. Removed because it refuses to work with LaTeX-mode
...
#     (setq flycheck-languagetool-server-jar "/opt/homebrew/Cellar/languagetool/6.6/libexec/languagetool-server.jar"))
#   :custom
#   (add-to-list 'flycheck-languagetool-language 'LaTeX-mode)
...
** SRC Blocks
- Add tree sitter language modes
